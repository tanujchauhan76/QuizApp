...
function config() {
    ...
    $config.loadingBars_width = 640;
    $config.loadingBars_height = 20;
    $config.loadingBars_border_color = '#286135';
    $config.loadingBars_color =  '#28a745';
    $config.loadingBars_background_color =  '#ffffff';
...
function setTimer($distance) {
    ...
    var timeLeft = "&#9203; Time Left - "+hours + ":" + minutes + ":" + seconds;
